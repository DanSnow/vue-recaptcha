...
<template>
  <div>
    <div id="checkbox">
      <h2>Checkbox</h2>
      <RecaptchaCheckbox v-model="checkboxResponse" v-model:widget-id="checkboxWidgetID" />
    ...
    <div id="invisible">
      ...
      <RecaptchaChallengeV2 v-model="challengeV2Response" v-model:widget-id="challengeV2WidgetID">
    ...
    <div id="v3">
      <h2>Challenge v3</h2>
      <RecaptchaChallengeV3 v-model="challengeV3Response" action="submit">
        <button>Submit</button>
